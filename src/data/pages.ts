...
function makeLocationPage(location: string): PageData {
  ...
  return {
    ...
    type: 'location',
    locationName: name,
    title: `Escorts in ${name} | Premium Call Girls Service 24/7 | Zarina`,
    ...
    intro: `Premium <strong>escorts in ${name}</strong> available 24/7. We provide verified call girls in ${name} with 24/7 availability for incall and outcall services. Also serving <a href="/" style="color:#800080;text-decoration:none;border-bottom:2px solid #800080;">Mumbai escorts</a> and other major areas.`,
    ...
    ogImage: `https://hotzarina.in/images/escorts/${slug}.webp`,
    schemaName: `Zarina Escorts ${name}`,
...
function makeCategoryPage(cat: string, customData?: Partial<PageData>): PageData {
  ...
  return {
    ...
    type: 'category',
    locationName: 'Mumbai',
    title: `${name} Mumbai | Premium Call Girls 24/7 | Zarina`,
    ...
    ogImage: `https://hotzarina.in/images/hero-banner.webp`,
    schemaName: `Zarina Escorts Mumbai`,
    schemaLat: 19.076,
    schemaLng: 72.8777,
